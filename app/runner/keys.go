...
var vkToHID = map[int32]uint8{
	...
	0x23: keyboard.KeyEnd, 0x24: keyboard.KeyHome,
	...
	0xC0: keyboard.KeyGrave,
	0xDB: keyboard.KeyLeftBrace, 0xDC: keyboard.KeyBackslash,
...
func isToggleVK(vk int32) bool {
	for _, toggle := range timing.ToggleVKs {
		if vk == toggle {
			return true
		}
	}
